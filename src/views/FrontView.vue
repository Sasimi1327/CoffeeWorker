...
<template>
  <div class="wrapper">
    ...
    <footer class="container-fluid align-self-end bg-black px-10">
      <div class="row">
        ...
        <address class="col-md-6 col-lg-4 my-md-10">
          ...
          <ul class="row flex-column list-unstyled text-white">
            ...
            <li class="offset-1 col-11 mb-5 align-middle fz-6">
              <span class="material-symbols-outlined py-1 mr-3
                d-inline-flex align-bottom">mail</span>
            ...
            <li class="offset-1 col-11 align-middle fz-6">
              <span class="material-symbols-outlined py-1 mr-3
                d-inline-flex align-bottom">home</span>
              台北市北投區天母西路132號
            </li>
          </ul>
        </address>
